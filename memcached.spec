...
Version  : 1.6.35
Release  : 82
URL      : https://memcached.org/files/memcached-1.6.35.tar.gz
Source0  : https://memcached.org/files/memcached-1.6.35.tar.gz
...
%prep
%setup -q -n memcached-1.6.35
cd %{_builddir}/memcached-1.6.35
pushd ..
cp -a memcached-1.6.35 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738598566
