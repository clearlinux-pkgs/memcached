...
Version  : 1.5.13
Release  : 31
URL      : http://memcached.org/files/memcached-1.5.13.tar.gz
Source0  : http://memcached.org/files/memcached-1.5.13.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1555422140
export AR=gcc-ar
