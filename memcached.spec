...
Source0  : https://memcached.org/files/memcached-1.6.8.tar.gz
...
%prep
%setup -q -n memcached-1.6.8
cd %{_builddir}/memcached-1.6.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603929278
...
cp %{_builddir}/memcached-1.6.8/COPYING %{buildroot}/usr/share/package-licenses/memcached/48d3aad525d9acd423ac6021c44fa4d15d4ee9ad
cp %{_builddir}/memcached-1.6.8/LICENSE.bipbuffer %{buildroot}/usr/share/package-licenses/memcached/7d1d9235b1b589f4347e7e2452db90d57b04fea9
%make_install
