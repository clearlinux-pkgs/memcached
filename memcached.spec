...
Version  : 1.6.2
Release  : 46
URL      : https://memcached.org/files/memcached-1.6.2.tar.gz
Source0  : https://memcached.org/files/memcached-1.6.2.tar.gz
...
%prep
%setup -q -n memcached-1.6.2
cd %{_builddir}/memcached-1.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585074769
...
cp %{_builddir}/memcached-1.6.2/COPYING %{buildroot}/usr/share/package-licenses/memcached/48d3aad525d9acd423ac6021c44fa4d15d4ee9ad
cp %{_builddir}/memcached-1.6.2/LICENSE.bipbuffer %{buildroot}/usr/share/package-licenses/memcached/7d1d9235b1b589f4347e7e2452db90d57b04fea9
%make_install
