...
Version  : 1.5.16
Release  : 35
URL      : http://memcached.org/files/memcached-1.5.16.tar.gz
Source0  : http://memcached.org/files/memcached-1.5.16.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564981437
