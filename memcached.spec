...
Source0  : https://memcached.org/files/memcached-1.6.10.tar.gz
...
%prep
%setup -q -n memcached-1.6.10
cd %{_builddir}/memcached-1.6.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627323712
...
cp %{_builddir}/memcached-1.6.10/COPYING %{buildroot}/usr/share/package-licenses/memcached/48d3aad525d9acd423ac6021c44fa4d15d4ee9ad
cp %{_builddir}/memcached-1.6.10/LICENSE.bipbuffer %{buildroot}/usr/share/package-licenses/memcached/7d1d9235b1b589f4347e7e2452db90d57b04fea9
%make_install
