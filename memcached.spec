...
Version  : 1.6.25
Release  : 72
URL      : https://memcached.org/files/memcached-1.6.25.tar.gz
Source0  : https://memcached.org/files/memcached-1.6.25.tar.gz
...
%prep
%setup -q -n memcached-1.6.25
cd %{_builddir}/memcached-1.6.25
pushd ..
cp -a memcached-1.6.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710945468
