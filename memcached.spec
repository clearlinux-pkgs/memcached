...
Version  : 1.6.36
Release  : 83
URL      : https://memcached.org/files/memcached-1.6.36.tar.gz
Source0  : https://memcached.org/files/memcached-1.6.36.tar.gz
...
%prep
%setup -q -n memcached-1.6.36
cd %{_builddir}/memcached-1.6.36
pushd ..
cp -a memcached-1.6.36 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738768629
