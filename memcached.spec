...
Source0  : https://memcached.org/files/memcached-1.6.22.tar.gz
...
%prep
%setup -q -n memcached-1.6.22
cd %{_builddir}/memcached-1.6.22
pushd ..
cp -a memcached-1.6.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697468860
