...
Source0  : https://memcached.org/files/memcached-1.6.28.tar.gz
...
%prep
%setup -q -n memcached-1.6.28
cd %{_builddir}/memcached-1.6.28
pushd ..
cp -a memcached-1.6.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717430310
