...
Version  : 1.6.14
Release  : 58
URL      : https://memcached.org/files/memcached-1.6.14.tar.gz
Source0  : https://memcached.org/files/memcached-1.6.14.tar.gz
...
%prep
%setup -q -n memcached-1.6.14
cd %{_builddir}/memcached-1.6.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644512980
...
cp %{_builddir}/memcached-1.6.14/COPYING %{buildroot}/usr/share/package-licenses/memcached/48d3aad525d9acd423ac6021c44fa4d15d4ee9ad
cp %{_builddir}/memcached-1.6.14/LICENSE.bipbuffer %{buildroot}/usr/share/package-licenses/memcached/7d1d9235b1b589f4347e7e2452db90d57b04fea9
cp %{_builddir}/memcached-1.6.14/vendor/mcmc/LICENSE %{buildroot}/usr/share/package-licenses/memcached/4b3f62d5726ced2394f025b2c6febeafdb3c571b
%make_install
