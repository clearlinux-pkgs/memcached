...
Source0  : https://memcached.org/files/memcached-1.6.32.tar.gz
...
%prep
%setup -q -n memcached-1.6.32
cd %{_builddir}/memcached-1.6.32
pushd ..
cp -a memcached-1.6.32 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729530233
